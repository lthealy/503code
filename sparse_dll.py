...
# Use return_tail to return last node
print('--- return_tail returns last node ---')
vec1.return_tail()

# Use return_head to return first node
print('--- return_first returns first node ---')
vec1.return_head()

# print updated size
print('--- updated DLL length ---')
vec1._length()
